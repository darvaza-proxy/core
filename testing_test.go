...
func testMockTInitialState(t *testing.T) {
	...
	AssertFalse(t, mock.HelperCalled, "initial HelperCalled")
}
...
func testMockTHelper(t *testing.T) {
	...
	mock.Helper()
	AssertTrue(t, mock.HelperCalled, "HelperCalled after Helper()")
}
...
func testMockTReset(t *testing.T) {
	...
	AssertFalse(t, mock.HelperCalled, "HelperCalled after Reset")
